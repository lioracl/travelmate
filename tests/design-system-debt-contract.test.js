...
test('design-system CSS debt does not grow while ownership is being consolidated', () => {
  ...
  assert.ok(counts.tripRedesign <= 127, `trip-redesign.css !important debt grew to ${counts.tripRedesign}`);
  assert.ok(
    counts.theme + counts.readableGlass + counts.tripRedesign <= 2088,
