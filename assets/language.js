(function () {
  ...
  var en = {
    ...
    'יומן מסע אוטומטי': 'Automatic travel journal', 'סיכום הטיול': 'Trip summary', 'רענון': 'Refresh', 'שדרוג עם Mate': 'Enhance with Mate', 'העתקה': 'Copy',
    ...
    'העוזר האישי של TravelMate': 'TravelMate personal assistant', 'Mate · העוזר האישי שלך': 'Mate · your personal assistant',
  ...
  Object.assign(en, {
    ...
    'היי, אני Mate 👋': 'Hi, I’m Mate 👋', 'הקראה': 'Read aloud', 'העתקה': 'Copy',
    ...
    'היי, אני Mate 👋 העוזר האישי שלך ב־TravelMate. אפשר לשאול אותי על יעדים, תכנון, תקציב, אריזה — או על כל נושא אחר.': 'Hi, I’m Mate 👋 your personal TravelMate assistant. Ask me about destinations, planning, budgets, packing — or anything else.',
