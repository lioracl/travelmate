...
Release baseline: TravelMate `1.55.11`  
PWA baseline: `travelmate-smart-v199`  
Asset baseline: `20260925-02`
...
Pre-Codex ownership cleanup:
- Budget V2 is the only active owner of budget allocation/workspace rendering; do not restore the legacy percentage split generated by custom-trip.js.
- Lodging Manager persists only its managed hotel/airport anchors via Trip Store update/merge semantics; do not replace this with a whole-trip snapshot save.
